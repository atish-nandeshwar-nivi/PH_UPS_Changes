                    ...
                    if (addressTable?.Rows.Count > 0)
                    {
                            ...
                            || addressTable.Columns.Contains("Zip5"))
                        {
                            foreach (DataRow row in addressTable.Rows)
                            {
                                ...
                                {
                                    Address1 = string.Concat((row.Table.Columns.Contains("Address2") ? Convert.ToString(row["Address2"])?.Replace("\r\n", string.Empty).Trim() : string.Empty), " ", (row.Table.Columns.Contains("Address1") ? Convert.ToString(row["Address1"])?.Replace("\r\n", string.Empty).Trim() : string.Empty)),
