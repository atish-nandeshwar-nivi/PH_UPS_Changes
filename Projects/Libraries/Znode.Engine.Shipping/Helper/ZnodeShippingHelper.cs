...
namespace Znode.Engine.Shipping.Helper
{
    public class ZnodeShippingHelper : IZnodeShippingHelper 
    {
        ...
        public virtual PortalModel GetPortal(int portalId)
             => (from portalCatalog in _portalCatalogRepository.Table
                 ...
                 select new PortalModel { PortalId = portalId, CatalogName = publishCatalog.CatalogName, PublishCatalogId = publishCatalog.PublishCatalogId })?.FirstOrDefault();
