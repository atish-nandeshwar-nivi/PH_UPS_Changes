class Endpoint extends ZnodeBase {
    ...
    AmazonShippingOptions(OrderReferenceId: string, paymentSettingId: number, total: string, accesstoken: string, callbackMethod) {
        super.ajaxRequest("/Checkout/AmazonShippingOptions", Constant.GET, { "amazonOrderReferenceId": OrderReferenceId, "paymentSettingId": paymentSettingId, "total": total, "accesstoken": accesstoken }, callbackMethod, "html", true);
    }
    ...
    LogAuthNetIframeResponse(portalId: number, response: string, callbackMethod) {
        super.ajaxRequest("/Checkout/LogAuthNetIframeResponse", Constant.GET, { "portalId": portalId, "response": response }, callbackMethod, "json", false)
    }
    ...
    //Nivi Code start  
    CustomAddtoCart(productId, quantity, callbackMethod) {
        super.ajaxRequest("/Product/CustomAddToCart", Constant.Post, { "productId": productId, "quantity": quantity }, callbackMethod, "json", true);
    }
    //Nivi code end
}