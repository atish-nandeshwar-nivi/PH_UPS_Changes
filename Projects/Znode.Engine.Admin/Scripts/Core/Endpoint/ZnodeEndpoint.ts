class Endpoint extends ZnodeBase {
    ...
    GetTemplateList(importHeadId: number, familyId: number, callbackMethod) {
        super.ajaxRequest("/Import/BindTemplateList", "post", { "importHeadId": importHeadId, "familyId": familyId }, callbackMethod, "json");
    }

    GetTemplateMappings(templateId: number, importHeadId: number, familyId: number, callbackMethod) {
        super.ajaxRequest("/Import/GetAssociatedTemplateList", "post", { "templateId": templateId, "importHeadId": importHeadId, "familyId": familyId }, callbackMethod, "json");
    }
