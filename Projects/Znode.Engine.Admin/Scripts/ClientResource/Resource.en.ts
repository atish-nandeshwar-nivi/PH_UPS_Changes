class en {
    ...
    OnlyAlphanumericareAllowed: string = "Only alphanumeric are allowed, No special characters or spaces.";
    ...
    AlphabetsAllowed: string = "Only lowercase alphabets and numbers  are allowed with character limit 255. Spaces and special character are not allowed."
    ...
    ErrorAllPaymentConfigurationsAdded: string = "All payment configurations are already added.";
